...
class AcronymsRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.put(`${this.path}/:name`, validationMiddleware(CreateAcronymDto, 'body', true), this.acronymsController.updateAcronym);
    this.router.delete(`${this.path}/:name`, this.acronymsController.deleteAcronym);
  }
}
